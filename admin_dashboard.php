...
<head>
	...
	<style type="text/css">
		...
		#right_side{
			height: 78%;
			width: 68%;
			background-color: rgba(13, 19, 14, 0.5);
			position: fixed;
			left: 17%;
			top: 21%;
			
			color: rgb(248, 148, 108);
...
<body>
	<div id="header"><br>
		<center>School Management System &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <?php echo $_SESSION['email'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:<?php echo $_SESSION['name'];?> 
					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table>
							...
							<tr>
								...
								<td>			
									<input type="result" value="<?php echo $row['result']?>" disabled>					
									<!-- <select name="sresult" id="sresult">
										<option value="<?php echo $row['result']?>">None</option>
										<option value="<?php echo $row['result']?>">Pass</option>
										<option value="<?php echo $row['result']?>">Fail</option>									
									  </select> -->
								</td>
							</tr>
							<tr>
				...
				while ($row = mysqli_fetch_assoc($query_run)) 
				{
					...
					<form action="admin_edit_student.php" method="post">
						...
						<tr>
							...
							<td>	
								<input type="result" name="result" value="<?php echo $row['result']?>"> 
								
							</td>
							<td>
								<p><strong>Note: choose pass , fail, or none only.!</strong></p >
							</td>
						</tr>
						<tr>
							<td>
